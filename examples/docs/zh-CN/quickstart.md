...
```javascript
import Vue from 'vue';
import ElementUI from 'vlight';
import 'vlight/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'vlight';
import App from './App.vue';
